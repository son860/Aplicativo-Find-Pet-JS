...
function fetchAnimals(e) {
    ...
    if (!(0, _validate.isValidZip)(zip)) {
        (0, _validate.showMessage)('Entre com o Zipcode válido', 'danger');
        return;
    }

    //Fetch Pets
    (0, _fetchJsonp2.default)('http://api.petfinder.com/pet.find?format=json&key\n               =7bec9c7514d4e1627003a8d320ba4286&animal=' + animal + '\n               &location=' + zip + '&callback=callback', {
...
//# sourceMappingURL=/main.f88f9f5e.map